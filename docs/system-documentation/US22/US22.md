...
> **Question:** A US não especifica ao certo dependências relacionadas à US21 (As Receptionist, I want to schedule a vaccine administration for an SNS user.), sendo assim, a chegada de um SNS user 
> só pode ser registada se existir um agendamento prévio para esse dia? 
> A US22 também não especifica ao certo o que é criado no sistema, quando é registada uma chegada. É criado algum tipo de check-in ou evento de chegada quando é feito o registo?
>
> **Answer:** Sim, o registo da chegada do SNS user só pode ser efetuado se existir um agendamento prévio para esse dia e para esse centro de vacinação. 
> Isto garante que não há chegadas sem marcação. Quando a chegada é registada, o sistema deve criar um evento ou estado que represente o check-in do SNS user. 
> Esse registo é necessário para cumprir os critérios de aceitação (AC22-1 e AC22-2).
...
- The arrival register is dependent of a existing SNS user.
